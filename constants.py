...
ROLLING_PERIODS = 30
SHIFT_PERIODS = 0
MARGIN_PERCENT = 0.20        # Reduced from 0.40 — deploy less margin per session
MAX_POSITIONS = 10
...
PROFIT_THRESHOLD = 0.35      # trailing activates at 35% of max_loss in profit
...
JOHANSEN_PERIODS = 70             # Bars fetched specifically for Johansen test (separate from PERIODS used for z-score/Kalman)
