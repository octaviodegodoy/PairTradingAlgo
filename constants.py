...
ROLLING_PERIODS = 30
SHIFT_PERIODS = 0
MARGIN_PERCENT = 0.25        # Reduced from 0.40 — deploy less margin per session
MAX_POSITIONS = 10
...
Z_SCORE_ENTRY_THRESHOLD = 1.8  # Raised from 1.35 — higher quality signals only (~96th pct)
MARGIN_Y = 100
MARGIN_X = 150
VOLUME_FACTOR = 12
FIBO_VOLUME_FACTORS = [1,1,1,1,1,2,3]  # Flat sizing for first 5 grids (was [1,1,2,3,5,8,13] Martingale)
PROFIT_THRESHOLD = 0.85      # Raised from 0.60 — trailing activates at 85% of max_loss in profit → R:R > 1
