        ...
        while True:
            ...
            while check_trading_time():
                ...
                if positions:
                    ...
                    correlation, hedge_ratio, spreads, rolling_z_scores, pair, arbitrage_found, vol_skew_signal = pair_trading_strategy.scan_pairs_arbitrage()                
                    if arbitrage_found:
                        ...
                        trade_execution.execute_trade(pair[0], pair[1], correlation, hedge_ratio, rolling_z_scores, vol_skew_signal)
